...
ICP =  [1,2,3,4,5,6,12,13,14,15,16,21,22,23,24,25,26,31,32,33,34,35,36,80]
# mesh interval
NTST=  100
# Collocation point
NCOL=   5
...
NPAR=   80
#Output Control
unames = {1:'R', 2:'c', 3:'ct', 4:'h', 5:'p', 6:'L'}
parnames = {1:'V_plc', 2:'V_pkc', 3:'delta', 4:'sw', 5:'tau_max', 6:'Ktau', 12:'lambda1', 13:'lambda2', 14:'lambda3', 15:'lambda4', 16:'lambda5'}  
# Special weights
THL =  {}, THU =  {}
