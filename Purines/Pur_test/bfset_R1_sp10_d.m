...
Fig5 = dlmread('HB12P_R1_sp10_d0.csv',',',1,1);
Fig6 = dlmread('HB12Pm_R1_sp10_d0.csv',',',1,1);
Fig7 = dlmread('HB22P_R1_sp10_d0.csv',',',1,1);
Fig8 = dlmread('HB22Pm_R1_sp10_d0.csv',',',1,1);
...
xlabel('V_{PLC}')
ylabel('K_{PLC}')
text(1.5,1.93,'\sigma_{PLC} = 10','Color','b','FontSize',20)
hold on
text(1.5,1.8,'\sigma_{PLC} = 10, \delta = 0','Color','r','FontSize',20)
grid minor
ax=gca;
set(ax,'Linewidth',4)
ax.FontSize=20;
